...
**URL:** https://v6.ai-sdk.dev/docs/foundations/streaming

## Overview

Streaming conversational text UIs (like ChatGPT) have gained massive popularity. This section explores the benefits and drawbacks of streaming and blocking interfaces.
...
For an introduction to streaming UIs and the AI SDK, check out the Getting Started guides.
